 ...
 * http://sizzlejs.com/
 *
 * Copyright 2005, 2013 fjQuery Foundation, Inc. and other contributors
...
var
	...
	rootjQuery,	//document 压缩考虑 [866] 代码维护性考虑
	...
	core_strundefined = typeof undefined,	//字符串型'undefined'

	// Use the correct document accordingly with window argument (sandbox)
	location = window.location,
	document = window.document,
	docElem = document.documentElement,		//缩短查找速度以及优化压缩
...
function dataAttr( elem, key, data ) {
	...
	// 如果this.cache没有data,那么就从html的dom元素的data-属性上获取值
